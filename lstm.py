...
Original file is located at
    https://colab.research.google.com/drive/1PfuEpf1GiwqoCKNNx6RhhANpNFA4iMi0
"""
...
plt.plot(predicted_stock_price, color='blue', label='Previsões de ações do Google')
plt.title('Previsões de ações do Google')
plt.xlabel('Tempo')
plt.ylabel('Ações do Google')
plt.legend()
plt.show()
